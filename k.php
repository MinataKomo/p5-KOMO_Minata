...
if(isset($_POST['connexion'])){
    ...
    if(empty($_POST['email'])){
        ...
        if(empty($_POST['passe'])){
            ...
            $MotDePasse = htmlentities($_POST['passe'], ENT_QUOTES, "UTF-8");
            ...
            if(!$mysqli){
                ...
                $Requete = mysqli_query($mysqli,"SELECT * FROM connecte WHERE email = '".$email."' AND passe= '".$passe."'");
...
exit;//on affiche pas le reste de la page pour faire une red
                }
            }
        }
    }
